...
debug: 
	...
	gcc tree_gen/tree_generator_biased.c -o tree_generator_biased -lm
	gcc tree_gen/tree_queries.c -o tree_queries -lm
	gcc -D LA_ALGORITHM=1 -D DEBUG_RESULTS=$(DEBUG_R) $(MAIN_LA_FILES) algorithms/table.c -o table -lm
	gcc -D LA_ALGORITHM=2 -D DEBUG_RESULTS=$(DEBUG_R) $(MAIN_LA_FILES) algorithms/jump_pointer.c -o jump_pointer -lm
	gcc -D LA_ALGORITHM=3 -D DEBUG_RESULTS=$(DEBUG_R) $(MAIN_LA_FILES) algorithms/ladder.c -o ladder -lm
	gcc -D LA_ALGORITHM=4 -D DEBUG_RESULTS=$(DEBUG_R) $(MAIN_LA_FILES) algorithms/jump_*.c algorithms/ladder.c -o jump_ladder -lm
	gcc -D LA_ALGORITHM=5 -D DEBUG_RESULTS=$(DEBUG_R) $(MAIN_LA_FILES) algorithms/macro_micro.c algorithms/ladder.c -o macro_micro -lm
	gcc -D LA_ALGORITHM=6 -D DEBUG_RESULTS=$(DEBUG_R) $(MAIN_LA_FILES) algorithms/menghani_matani.c -o menghani_matani -lm
	gcc -D LA_ALGORITHM=7 -D DEBUG_RESULTS=$(DEBUG_R) $(MAIN_LA_FILES) algorithms/hagerup.c -o hagerup -lm
