LA_DYNAMIC := -D LA_DYNAMIC=1 vec.c
...
dynamic: 
	...
	gcc tree_gen/tree_generator_biased.c -o tree_generator_biased -lm
	gcc tree_gen/tree_queries.c -o tree_queries -lm
	gcc -D LA_ALGORITHM=1 $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/table.c -o table -lm
	gcc -D LA_ALGORITHM=2 $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/jump_pointer.c -o jump_pointer -lm
	gcc -D LA_ALGORITHM=3 $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/ladder.c -o ladder -lm
	gcc -D LA_ALGORITHM=4 $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/jump_*.c algorithms/ladder.c -o jump_ladder -lm
...
dynamic-debug: 
	...
	gcc tree_gen/tree_generator_biased.c -o tree_generator_biased -lm
	gcc tree_gen/tree_queries.c -o tree_queries -lm
	gcc -D LA_ALGORITHM=1 $(DEBUG_RESULTS) $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/table.c -o table -lm
	gcc -D LA_ALGORITHM=2 $(DEBUG_RESULTS) $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/jump_pointer.c -o jump_pointer -lm
	gcc -D LA_ALGORITHM=3 $(DEBUG_RESULTS) $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/ladder.c -o ladder -lm
	gcc -D LA_ALGORITHM=4 $(DEBUG_RESULTS) $(LA_DYNAMIC) $(MAIN_LA_FILES) algorithms/jump_*.c algorithms/ladder.c -o jump_ladder -lm
